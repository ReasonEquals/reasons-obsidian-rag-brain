...
def search_vault(query: str, top_k: int = 5, full: bool = False) -> None:
...
if __name__ == "__main__":
    ...
    search_vault(args.query, top_k=args.top, full=args.full)
